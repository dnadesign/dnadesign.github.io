...
If an <a> is styled in the outer component, that style should not flow through to the inner component. However if the css uses a rule like: .header a then this will be the case.
